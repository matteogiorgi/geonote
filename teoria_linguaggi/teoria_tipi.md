...
Questa nota non è organizzata linguaggio per linguaggio, ma per assi: statico/dinamico, forte/debole, inferenza, nominale/strutturale, gestione del "niente", tipi somma, polimorfismo, soundness. Ogni asse è per lo più ortogonale agli altri — il primo mito da smontare, ripreso nel [§3](#3-vocabolario-e-assi-ortogonali), è che "statico" implichi "forte" o che "dinamico" implichi "debole": non è così. Otto linguaggi ricorrono come illustrazioni lungo questi assi — **C**, **Go**, **OCaml**, **Haskell**, **Java**, **Guile** (Scheme, vedi [fondamenti_guile](../fondamenti/fondamenti_guile.md)), **JavaScript** e **R** (vedi [fondamenti_r](../fondamenti/fondamenti_r.md)) — scelti non per completezza ma perché ciascuno drammatizza al meglio uno o più assi; **Bash** compare come *cameo* fuori tabella nel [§17](#17-box--bash-il-pavimento), il "pavimento" dello spettro dove il concetto stesso di tipo quasi scompare.
...
R non illustra un asse pulito quanto gli altri, ma è un caso di studio prezioso per due ragioni indipendenti dal resto della nota (si veda anche [fondamenti_r](../fondamenti/fondamenti_r.md)).
